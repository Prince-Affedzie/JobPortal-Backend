...
clientRouter.post("/h1/v2/post_mini_task", verify_token, postMiniTask);
clientRouter.post("/h1/v2/generate_task_media_upload_url",verify_token,generateTaskMediaUploadURL)
clientRouter.put("/h1/v2/assign/mini_task/:taskId/:applicantId", verify_token, assignMiniTask);
clientRouter.put("/h1/v2/accept_bid/mini_task/:taskId/:bidId", verify_token, acceptBid);
...
clientRouter.put("/h1/v2/edit/mini_task/:Id", verify_token,  editMiniTask);
clientRouter.put("/h1/v2/mark_task_as_done/client/:Id", verify_token,  markTaskDoneByClient);
clientRouter.put("/h1/v2/mark_task__undone/client/:Id", verify_token,  unmarkTaskDoneByClient);
clientRouter.delete("/h1/v2/delete/mini_task/:Id", verify_token,  deleteMiniTask);
