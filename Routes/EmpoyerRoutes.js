...
const {verifyJobPostingEligibility} = require("../MiddleWare/EligibilityVerification.js")
...
employerRoute.post("/h1/v1/add_job",verify_token,verifyJobPostingEligibility,addJob)
employerRoute.put("/h1/v1/update_job/:Id",verify_token,verifyJobPostingEligibility,editJob)
employerRoute.delete("/h1/v1/delete_job/:Id",verify_token,verifyJobPostingEligibility,deleteJob)
